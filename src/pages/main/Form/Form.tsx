      ...
      <Paper style={{ padding: "18px" }}>
        <Grid container spacing={3}>
          ...
          <Grid item container spacing={3} alignItems="center">
            ...
            <Grid item xs={6}>
              <Select fullWidth value={reason} onChange={handleReason}>
                <MenuItem value="Point of Order">Point of Order</MenuItem>
                ...
                <MenuItem value="Speak (Other)">Speak (Other)</MenuItem>
                <MenuItem value="Motion (Specify)">Motion (Specify)</MenuItem>
              </Select>
            </Grid>
          </Grid>
          <Grid item container spacing={3} alignItems="center">
